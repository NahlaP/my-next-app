...
//   const handleIncrease = (slug: string, qty: number) => {
//     dispatch(updateCartItemQuantity({ slug, quantity: qty + 1 }));
//   };

//   const handleDecrease = (slug: string, qty: number) => {
//     if (qty > 1) {
//       dispatch(updateCartItemQuantity({ slug, quantity: qty - 1 }));
//     }
//   };
...
//                   <button
//                     className="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-400 transition"
//                     onClick={() => handleIncrease(item.slug, item.quantity)}
//                   >
//                     +
//                   </button>
//                   <button
//                     className="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-400 transition"
//                     onClick={() => handleDecrease(item.slug, item.quantity)}
//                   >
//                     -
//                   </button>
//                 </div>
